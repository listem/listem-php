...
class FiltersList extends AbstractList
{
     ...
     * List of filters.
     *
     * @var Devrtips\Listr\FiltersList
     */
    protected $items;
    ...
    public function getItems()
    {
        if (is_null($this->items)) {
            ...
            $filtersList = $this->getListFromConfig();
            $list = [];
    ...
    /**
     * Return new Filter instance. If an array is passed, populate the existing
     * properties of the instance with them.
     *
     * @param array $properties
     * @return \Devrtips\Listr\Filter
     */
    protected function getNewFilter($properties = [])
    {
        $filter = new Filter();
     ...
     * @throws Exception
     */
    protected function getListFromConfig()
    {
